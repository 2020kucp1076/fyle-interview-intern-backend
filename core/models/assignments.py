...
class Assignment(db.Model):
    ...
    def upsert(cls, assignment_new: 'Assignment'):
        ...
        assertions.assert_valid(assignment_new.content is not None, 'content of assignment cannot be empty')
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.state != AssignmentStateEnum.DRAFT, 'only submitted and already graded assignment can be graded')
